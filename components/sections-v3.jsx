  ...
  return (
    <nav style={{
      ...
      <div className="gg-nav-d" style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
        {links.map(({ l, href }, i) => l === 'Tienda'
          ? <a key={l} href={href} style={{ textDecoration: 'none' }}><CrayonButton fill={PALETTE.heart} stroke={PALETTE.ink} color={PALETTE.cream}>Tienda</CrayonButton></a>
...
const ScrollStory = ({ t }) => {
  ...
  const beats = [
    { kicker: 'HOLA, SOY TU PLANTA', title: 'Hola.\nSoy tu planta.', body: 'Por primera vez, puedo contarte cómo me siento. No solo me riegues — escúchame.', card: 'alegre', photo: 'assets/pots/colors/verde.png', speech: '¡Soy feliz contigo!', personality: 'Alegre' },
    { kicker: 'CUATRO SENTIDOS', title: 'Cuatro\nsensores.', body: 'Humedad del suelo, humedad del aire, temperatura y luz. Los mido en silencio, cada minuto.', card: 'dormilona', photo: 'assets/pots/colors/azul.png', speech: 'Déjame dormir...', personality: 'Dormilona' },
    { kicker: 'YO INICIO LA CONVERSACIÓN', title: 'Te toco\nla puerta.', body: 'Cuando tengo sed, frío o demasiada sombra, te lo digo. Sin abrir la app — yo hablo primero.', card: 'dramatica', photo: 'assets/pots/colors/morado.png', speech: '¡Esto es un drama!', personality: 'Dramática' },
    { kicker: 'MEMORIA DE PLANTA', title: 'Recuerdo\ntodo.', body: 'Guardo 30 días de mi vida. Cada mes, un informe de cómo crecí y qué tan feliz estuve contigo.', card: 'exigente', photo: 'assets/pots/colors/naranja.png', speech: '¿Ya me diste agua?', personality: 'Exigente' },
  ];
...
const Personalities = ({ t }) => {
  ...
  const ppl = [
    { area: 'a', name: 'Alegre', color: '#F4D06F', photo: 'assets/personalities/collage/alegre.webp', trait: 'Luminosa', desc: 'Te saluda cada mañana con buen humor.', speech: '¡Salió el sol!', bubble: 'ovalo', deco: 'stars', rot: -4, bw: 200, fs: 20, lift: 1, bleft: '18%', ph: '82%', pop: '#EE9F33' },
    { area: 'b', name: 'Dormilona', color: '#8FBEEE', photo: 'assets/personalities/collage/dormilona.webp', trait: 'Tranquila', desc: 'Calladita; rara vez pide algo.', speech: 'Cinco minutos más...', bubble: 'nube-pensamiento', deco: 'zzz', rot: 3, bw: 140, fs: 13.5, lift: -84, pop: '#4E8FD4' },
    { area: 'c', name: 'Dramática', color: '#E0B8E0', photo: 'assets/personalities/collage/dramatica.webp', trait: 'Intensa', desc: 'Lo siente todo y te lo cuenta.', speech: '¡Esto es un drama!', bubble: 'explosion', deco: 'excl', rot: -3, bw: 140, fs: 13, lift: -95, pop: '#C75CB0' },
    { area: 'd', name: 'Exigente', color: '#A8C88A', photo: 'assets/personalities/collage/exigente.webp', trait: 'Directa', desc: 'Sabe lo que quiere y lo pide.', speech: 'Agua justa. Nada más.', bubble: 'estallido', deco: 'anger', rot: 4, bw: 138, fs: 13.5, lift: -82, inside: true, btop: '6%', ph: '82%', pop: '#5E9E38' },
  ];
  return (
              ...
              <div key={p.area} style={{ gridArea: p.area, minHeight: 0, position: 'relative', filter: 'drop-shadow(0 10px 18px rgba(61,40,23,0.18))' }}>
                ...
                <div style={{ position: 'absolute', top: p.inside ? p.btop : 0, left: p.bleft || '50%', transform: `translate(-50%,${p.inside ? 0 : p.lift}%) rotate(${p.rot}deg)`, zIndex: 5, pointerEvents: 'none' }}>
                  <TracedBubble shape={p.bubble} deco={p.deco} t={t} width={p.bw}>
                    <span style={{
                      fontFamily: t.bf, fontStyle: 'italic', fontWeight: 900, fontSize: p.fs, color: p.pop, lineHeight: 1.04, letterSpacing: '.2px',
                      WebkitTextStroke: `0.3px ${PALETTE.ink}`,
                      textShadow: `-1px 0 0 ${PALETTE.ink},1px 0 0 ${PALETTE.ink},0 -1px 0 ${PALETTE.ink},0 1px 0 ${PALETTE.ink},1px 1px 0 ${PALETTE.ink},-1px 1px 0 ${PALETTE.ink},1px -1px 0 ${PALETTE.ink},-1px -1px 0 ${PALETTE.ink},2px 3px 3px rgba(61,40,23,.3)`
                    }}>{p.speech}</span>
                  </TracedBubble>
                </div>
                <div style={{
      ...
      <CrayonCard fill={`${PALETTE.leaf}30`} stroke={PALETTE.ink} sw={3} radius={32} padding={48}>
        <Reveal>
          ...
          <div style={{ display: 'flex', gap: 14, justifyContent: 'center', marginTop: 24, flexWrap: 'wrap' }}>
            <a href="store.html" style={{ textDecoration: 'none' }}><CrayonButton fill={PALETTE.heart} stroke={PALETTE.ink} color={PALETTE.cream}>Comprar maceta</CrayonButton></a>
            <a href="store.html" style={{ textDecoration: 'none' }}><CrayonButton fill={PALETTE.cream} stroke={PALETTE.ink}>Ver la tienda</CrayonButton></a>
          </div>
        </Reveal>
        <Reveal delay={250}>
  ...
  return (
    <footer style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(140px,1fr))', gap: 28, maxWidth: 1080, margin: '0 auto' }}>
        ...
        {[
          { t: 'Producto', l: [{ n: 'Cómo funciona', h: 'how-it-works.html' }, { n: 'Personalidades', h: 'personalities.html' }, { n: 'Tienda', h: 'store.html' }] },
          { t: 'Recursos', l: [{ n: 'Blog', h: 'blog/index.html' }, { n: 'Guías', h: '#' }, { n: 'FAQ', h: 'store.html#faq' }] },
          { t: 'Legal', l: [{ n: 'Términos', h: 'terms.html' }, { n: 'Privacidad', h: 'privacy.html' }, { n: 'Contacto', action: 'contact' }] }
        ].map(col => (
          <div key={col.t}>
